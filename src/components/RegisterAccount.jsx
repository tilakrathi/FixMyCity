  ...
  return (
    ...
    >
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          handleRegistration(FormData)
            .then((user) => {
              console.log("currentUser", user); // requested debug log

              // Small delay ensures localStorage flush before component mount
              setTimeout(() => {
      ...
      >
        ...
        <Button variant="contained" type="submit" className="hover:scale-[1.02] transition-transform duration-200">
          Create Account
        </Button>
      </form>
    </div>
